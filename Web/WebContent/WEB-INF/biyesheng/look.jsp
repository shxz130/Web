...
<body class="templatemo-bg-gray">
	<h1 class="margin-bottom-15">查看信息</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" method="post">

			
			<input type="hidden" name="biyeshengid" readonly="readonly" value="${biyesheng.biyeshengid}" >
			<input type="hidden" name="dengjiriqi" readonly="readonly" value="${biyesheng.dengjiriqi}" >
			<input type="hidden" name="jibenid" readonly="readonly" value="${biyesheng.jiBenXinXi.jibenid}" >
			<input type="hidden" name="xuejiid" readonly="readonly" value="${biyesheng.xueJiXinXi.xuejiid}" >
				<input type="hidden" name="biyeid" readonly="readonly" value="${biyesheng.biYeXinXi.biyeid}" >
				<div class="form-inner">
					<div class="form-group">
			          <div class="col-md-12">		          	
			            <label for="username" class="control-label">姓名</label>
			            <input type="text" class="form-control" readonly="readonly" name="xingming" value="${biyesheng.jiBenXinXi.xingming}">
			   ...
			   <div class="form-group"> 
			           <div class="col-md-4">
			           			 ...
			           			 <input type="text" readonly="readonly" class="form-control" name="nianling" value="${biyesheng.jiBenXinXi.nianling}"><br>
			           			
			           </div>	  
			          	 <div class="col-md-4">
			          		 <label for="username" class="control-label">民族</label>
			          		 <input type="text" readonly="readonly" class="form-control" name="mingzu" value="${biyesheng.jiBenXinXi.mingzu}">
			          	...
			          	<div id="danxuan" class="col-md-4 templatemo-radio-group">
			          		...
			          		<label class="radio-inline">
		          				<input type="radio" readonly="readonly" name="xingbie" id="optionsRadios1" value="男"> 男
		          			</label>
		          			<label class="radio-inline">
		          				<input type="radio" readonly="readonly" name="xingbie" id="optionsRadios2" value="女"> 女
		          			</label>
			          	</div>        
			        </div>	
			       ...
			       <div class="form-group">
			          <div class="col-md-12">		          	
			           ...
			           <input type="text" readonly="readonly" class="form-control" name="shenfenzhenghao" value="${biyesheng.jiBenXinXi.shenfenzhenghao}">		            		            		            
			          </div>              
			        </div>	
			         ...
			         <div class="form-group">
			          <div class="col-md-12">
			            <label for="username" class="control-label">籍贯</label>
			            	<input type="text" readonly="readonly" class="form-control" name="jiguan" value="${biyesheng.jiBenXinXi.jiguan}">
			         	 </div>
			          </div>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            ...
			            <input type="text" readonly="readonly" class="form-control" name="shengyuandi" value="${biyesheng.jiBenXinXi.shengyuandi}">
			          </div>
			         </div>
			         <br><br>
			          <div class="form-group">
			          <div class="col-md-12">
			            ...
			            <input type="text" readonly="readonly" class="form-control" name="xuexiao" value="${biyesheng.xueJiXinXi.xuexiao}">
			          </div>
			        </div>
			         ...
			         <div class="form-group">
			          <div class="col-md-12">
			           ...
			           <input type="text" readonly="readonly" class="form-control" name="zhuanye" value="${biyesheng.xueJiXinXi.zhuanye}">
			          </div>
			        </div>
			          ...
			          <div class="col-md-12">
			           ...
			           <input type="text" readonly="readonly" class="form-control" name="banji" value="${biyesheng.xueJiXinXi.banji}">
			          </div>
			        </div>
			         ...
			         <div class="form-group">
			          <div class="col-md-12">
			           ...
			           <input type="text" readonly="readonly" class="form-control" name="xuehao" value="${biyesheng.xueJiXinXi.xuehao}">
			          </div>
			        </div>
			          ...
			          <div class="col-md-12">
			            ...
			            <input type="text" readonly="readonly" class="form-control" name="biyezhenghao" value="${biyesheng.biYeXinXi.biyezhenghao}">
			          </div>
			        </div>
			          ...
			          <div class="col-md-12">
			            ...
			            <input type="text" readonly="readonly" class="form-control" name="xueweihao" value="${biyesheng.biYeXinXi.xueweihao}">
			          </div>
			        </div>
			         ...
			         <div class="form-group">
			          <div class="col-md-6">
			            ...
			            <input type="text" readonly="readonly" class="form-control" name="xuewei" value="${biyesheng.biYeXinXi.xuewei}">
			          </div>
			           <div class="col-md-6">
			            <label for="username" class="control-label">毕业时间</label>
			            <input type="text" readonly="readonly" class="form-control" name="biyeshijian" value="${biyesheng.biYeXinXi.biyeshijian}">
